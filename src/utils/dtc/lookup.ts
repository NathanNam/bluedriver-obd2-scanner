...
const DTC_DATABASE: Record<string, string> = {
  ...
  P0042: 'Heated oxygen sensor heater circuit (Bank 1 Sensor 3)',
  P0043: 'Heated oxygen sensor heater circuit low (Bank 1 Sensor 3)',
  P0044: 'Heated oxygen sensor heater circuit high (Bank 1 Sensor 3)',
  ...
  P004A: 'Turbocharger/supercharger boost control circuit intermittent/erratic',
  P004B: 'Turbocharger/supercharger boost control circuit high',
  P004C: 'Turbocharger/supercharger boost control circuit low',
  ...
  P0056: 'Heated oxygen sensor heater circuit (Bank 2 Sensor 2)',
